...
export default function Impact(){
  return (
    <section id="impact" className="bg-gradient-to-b from-slate-900 to-slate-950 py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 md:px-6 grid items-start gap-8 md:grid-cols-2">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold">Impacto & Métricas</h2>
          <ul className="mt-4 grid gap-3 text-slate-300 list-disc pl-5">
        ...
        <Card>
          ...
          <p className="mt-3 text-xs text-slate-400">Indicador composto de demanda, investimento e política pública.</p>
        </Card>
      </div>
    </section>
  )
